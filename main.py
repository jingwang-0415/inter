...
from model.ops import load_data
...
def sep_data(args):
    ...
    train_dir = 'data/%s/train' % (args.data)
    valid_dir = 'data/%s/valid' % (args.data)
    test_dir = 'data/%s/test' % (args.data)
...
def main():
    ...
    train_idx, valid_idx , test_idx = sep_data(args)
    print(valid_idx)
